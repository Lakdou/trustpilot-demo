...
import shap # On importe SHAP pour le calcul
...
# ==============================================================================
# ONGLET 1 : DÉMO LIVE (AVEC SHAP SIMPLE & ROBUSTE)
# ==============================================================================
with tab_demo:
    if model is None:
        ...
        if st.button("Lancer l'analyse", type="primary"):
            if user_input.strip():
                with st.spinner('Calcul de la prédiction et analyse SHAP...'):
                    # 1. Pipeline & Prédiction
                    ...
                    # 3. VRAI SHAP SIMPLE (Calcul et Affichage Manuel)
                    st.markdown("---")
